...
export class FunctionsProvider {
  ...
  scheduleCountdownNotifications(){
    ...
    this.localNotifications.schedule({
      ...
      title: "🔥 24 hours left! ⏱",
      text: "⏱ Your chance to win a $50 gift card expires soon! Create a booking in the next 24 hours to be entered to win!",
    ...
    this.localNotifications.schedule({
      ...
      title: "🔥 One hour left! ⏱",
      text: "⏱ Your chance to win a $50 gift card expires soon! Create a booking in the next hour to be entered to win!",
  ...
  countdownAlert(type) {
    ...
    let alert = this.alertCtrl.create({
      ...
      subTitle: subTitle,
      message: "To our early users, thank you for your support! If you try out our app and make a booking in your first 3 days you will have a chance to win a $50 gift card! The contest expires on Dec. 31, 2018.",
      buttons: ['Got It']
    });
    alert.present();
  }
